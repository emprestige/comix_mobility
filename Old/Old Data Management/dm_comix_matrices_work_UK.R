...
e_weeks_frame$dominant_eigenvalue <- sapply(e_weeks_frame$dominant_eigenvalue, as.numeric)

#save dominant eigenvalues
qs::qsave(e_weeks_frame, file.path(data_path, "comix_eigens_work_UK.qs"))
