...
reproduction_all <- reproduction_all[, .(fortnight,reproduction_number = dominant_eigenvalue*2.0163628,
                                         reproduction_number_mob = dominant_eigenvalue_mob*2.0163628,
                                         reproduction_number_mob2 = dominant_eigenvalue_mob2*2.0163628,
                                         reproduction_number_lin = dominant_eigenvalue_lin*2.0163628,
                                         reproduction_number_quad = dominant_eigenvalue_quad*2.0163628)]
...
p5 <- ggplot(data = reproduction_all, aes(x = reproduction_number)) + 
  ...
  labs(x = "Reproduction Number (CoMix)", y = "Reproduction Number (Estimates)",
       colour = "Scaling Factor") + xlim(0, 6.5) + ylim(0, 6.5) + 
  geom_abline(intercept = 0, slope = 1, linetype = 2) +
  scale_color_manual(breaks = "mob", values = "purple", labels = "Mobility")
