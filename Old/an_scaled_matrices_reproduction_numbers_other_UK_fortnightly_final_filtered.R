...
scaling_factors <- qs::qread(file.path(data_path, "scaling_factors_UK_fortnightly_filtered.qs"))
...
eigens <- qs::qread(file.path(data_path, "comix_eigens_other_UK_fortnightly_filtered.qs"))
...
reproduction_all <- reproduction_all[, .(fortnight,reproduction_number = dominant_eigenvalue*0.1581799,
