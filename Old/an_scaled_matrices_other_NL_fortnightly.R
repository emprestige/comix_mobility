##using the scaling factors for The Netherlands
...
scaling_factors <- qs::qread(file.path(data_path, "scaling_factors_NL_fortnightly.qs"))
...
eigens <- qs::qread(file.path(data_path, "comix_eigens_other_NL_fortnightly.qs"))
...
ggplot(data = eigens_all) + 
  ...
  labs(x = "Fornight", y = "Dominant Eigenvalue",
