...
#model work data using linear regression with proportion attended work
...
#model work data using polynomial regression with proportion attended work
...
#model work data using linear regression with proportion attended work and stringency index
...
#model work data using polynomial regression with proportion attended work and stringency index
