...
# reproduction2 <- rlang::duplicate(reproduction_all)
# reproduction2 <- reproduction2[, group := ifelse(mid_date < "2020-12-24", 1, 2)]
# reproduction2$group <- as.factor(reproduction2$group)
