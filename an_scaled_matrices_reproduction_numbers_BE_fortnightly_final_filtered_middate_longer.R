...
contact_matrices <- qs::qread(file.path(data_path, "data", "contact_matrices_BE.qs"))
scaling_factors <- qs::qread(file.path(data_path, "data", "scaling_factors_BE_fortnightly_filtered_middate_longer.qs"))
...
eigens <- qs::qread(file.path(data_path, "data", "comix_eigens_work_BE_fortnightly_filtered_middate_longer.qs"))
...
#import dominant eigenvalues from comix matrices 
eigens <- qs::qread(file.path(data_path, "data", "comix_eigens_other_BE_fortnightly_filtered_middate_longer.qs"))
