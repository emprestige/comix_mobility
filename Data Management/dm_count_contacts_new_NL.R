...
pt_cnt_work <- pt_cnt_work[substr(part_wave_uid, 1, 2) == "nl"]
pt_cnt_other <- pt_cnt_other[substr(part_wave_uid, 1, 2) == "nl"]
...
#save as qs file
qs::qsave(pt_cnt_work, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\part_cnts_work_NL.qs")
qs::qsave(pt_cnt_other, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\part_cnts_other_NL.qs")
