...
pt <- qs::qread(file.path(data_path, "data", "participants_filt.qs"))
ct <- qs::qread(file.path(data_path, "data", "contact_filt_other.qs"))
...
qs::qsave(e_middates_frame, file.path(data_path, "data", "comix_eigens_other_UK_fortnightly_filtered_middate_longer.qs"))
