...
ct_work <- rlang::duplicate(ct)
ct_other <- rlang::duplicate(ct)
...
#save as qs file
qs::qsave(pt_cnt_work, file.path(dir_data_validate, "part_cnts_work_NL_longer.qs"))
qs::qsave(pt_cnt_other, file.path(dir_data_validate, "part_cnts_other_NL_longer.qs"))
