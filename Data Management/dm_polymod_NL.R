...
#load participant and contact data for Netherlands
poly_p = polymod$participants[country == "Netherlands"]
...
#save
qs::qsave(pnum, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\polymod_NL.qs")
