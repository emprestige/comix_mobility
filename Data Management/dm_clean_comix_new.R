...
pt_uk <- pt[country == "uk"]
ct_work_uk <- ct_work[country == "uk"]
ct_other_uk <- ct_other[country == "uk"]
...
ct_work_uk <- ct_work_uk[, ..ct_nmes]
ct_other_uk <- ct_other_uk[, ..ct_nmes]

#save data
qs::qsave(pt_uk, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\participants.qs")
qs::qsave(ct_work_uk, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\contact_work.qs")
qs::qsave(ct_other_uk, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\contact_other.qs")

#filter out bad rounds
ct_work_uk <- ct_work_uk[survey_round != "6"]
ct_other_uk <- ct_other_uk[survey_round != "6"]
pt_uk <- pt_uk[survey_round != "6"]
ct_work_uk <- ct_work_uk[survey_round != "7"]
ct_other_uk <- ct_other_uk[survey_round != "7"]
...
qs::qsave(ct_work_uk, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\contact_filt_work.qs")
qs::qsave(ct_other_uk, "C:\\Users\\emiel\\Documents\\LSHTM\\Fellowship\\Project\\comix_mobility\\Data\\contact_filt_other.qs")
