...
ct <- qs::qread(file.path(data_path, "data", "contact_work_BE.qs"))
...
qs::qsave(e_middates_frame, file.path(data_path, "data", "comix_eigens_work_BE_fortnightly_filtered_middate_longer.qs"))
