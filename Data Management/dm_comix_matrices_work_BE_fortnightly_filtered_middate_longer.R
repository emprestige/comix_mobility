...
pt_date <- pt[date <= ymd("2022-03-04")]
ct_date <- ct[date <= ymd("2022-03-04")]
...
qs::qsave(e_middates_frame, file.path(data_path, "comix_eigens_work_BE_fortnightly_filtered_middate_longer.qs"))
