...
#now for new subset
mob_sub2 <- mob[date >= "2020-04-16" & date <= "2021-03-31"]
...
qs::qsave(ests4, file.path(data_path, "scaling_factors_NL_fortnightly_filtered_middate.qs"))
