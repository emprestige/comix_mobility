...
comix <- qs::qread(file.path(data_path, "data", "participants_BE.qs"))
dates <- comix$date
...
qs::qsave(ests4, file.path(data_path, "data", "scaling_factors_BE_fortnightly_filtered_middate_longer.qs"))
