##estimate contact matrices from CoMix data for the NL
...
qs::qsave(e_middates_frame, file.path(data_path, "comix_eigens_other_NL_fortnightly_filtered_middate.qs"))
