...
ct <- qs::qread(file.path(data_path, "data", "contact_filt_work.qs"))
...
qs::qsave(e_middates_frame, file.path(data_path, "data", "comix_eigens_work_UK_fortnightly_filtered_middate_longer.qs"))
