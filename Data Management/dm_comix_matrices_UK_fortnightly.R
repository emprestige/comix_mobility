...
ids <- qs::qread(file.path(data_path, "filter_ids.qs"))
pt <- subset(pt, !(pt$part_id %in% ids))
...
qs::qsave(e_fortnights_frame, file.path(data_path, "comix_eigens_UK_fortnightly.qs"))
