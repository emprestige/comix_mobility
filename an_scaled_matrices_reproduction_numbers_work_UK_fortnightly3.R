...
#import multiplicative factor
multiplicative_factor <- qs::qread(file.path(data_path, "multiplicative_factors_UK.qs"))
...
reproduction_all <- merge(multiplicative_factor, reproduction_all, by = "fortnight")
reproduction_all <- reproduction_all[, .(fortnight,reproduction_number = dominant_eigenvalue*multiplicative_factor,
                                         reproduction_number_mob = dominant_eigenvalue_mob*multiplicative_factor,
                                         reproduction_number_mob2 = dominant_eigenvalue_mob2*multiplicative_factor,
                                         reproduction_number_lin = dominant_eigenvalue_lin*multiplicative_factor,
                                         reproduction_number_quad = dominant_eigenvalue_quad*multiplicative_factor)]
...
ggplot(data = reproduction_all) +
  ...
  geom_line(aes(x = fortnight, y = reproduction_number_lin, col = "lin"), group = 1) +
  geom_line(aes(x = fortnight, y = reproduction_number_quad, col = "quad"), group = 1) +
  geom_line(aes(x = fortnight, y = reproduction_number_model, col = "model"), group = 1, linetype = 2) +
  labs(x = "Fortnight", y = "Reproduction Number",
       colour = "Estimate Type") + scale_x_discrete(breaks = my_list) +
