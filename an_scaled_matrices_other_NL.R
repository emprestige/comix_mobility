...
scaling_factors <- qs::qread(file.path(data_path, "scaling_factors_NL.qs"))
...
eigens <- qs::qread(file.path(data_path, "comix_eigens_other_NL.qs"))
...
ggplot(data = eigens_all) + 
  ...
  labs(x = "Week", y = "Dominant Eigenvalue",
