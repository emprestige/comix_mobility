...
reproduction_all <- reproduction_all[, .(fortnight,reproduction_number = dominant_eigenvalue*0.2843283,
                                         reproduction_number_mob = dominant_eigenvalue_mob*0.2843283,
                                         reproduction_number_mob2 = dominant_eigenvalue_mob2*0.2843283,
                                         reproduction_number_lin = dominant_eigenvalue_lin*0.2843283,
                                         reproduction_number_quad = dominant_eigenvalue_quad*0.2843283)]
...
p5 <- ggplot(data = reproduction_all, aes(x = reproduction_number)) + 
  ...
  labs(x = "Reproduction Number (CoMix)", y = "Reproduction Number (Estimates)",
       colour = "Scaling Factor") + xlim(0, 1) + ylim(0, 1) + 
  geom_abline(intercept = 0, slope = 1, linetype = 2) +
  scale_color_manual(breaks = "mob", values = "purple", labels = "Mobility")
